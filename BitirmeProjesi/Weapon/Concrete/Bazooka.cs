...
{
    public class Bazooka : IRangedWeapon<Rocket>
    {
        public Bazooka( string model, int damage, string brand,int magazine, Rocket ammoType,bool scope, int shoottingAmmo)
        {
        ...
        public Rocket AmmoType { get; private set; }
