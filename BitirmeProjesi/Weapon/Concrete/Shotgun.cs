...
{
    public class ShotGun : IRangedWeapon<ShotgunAmmo>
    {
        public ShotGun( string model, int damage, string brand, int magazine, ShotgunAmmo ammoType, bool scope, int shoottingAmmo)
        {
        ...
        public ShotgunAmmo AmmoType { get; private set; }
